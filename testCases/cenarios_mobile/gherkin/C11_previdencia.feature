...
Como cliente Kinvo quero cadastrar uma aplicação em previdência
...
Quando selecionar a opção previdência
...
E a quantidade de cota <quantidade>
E clicar em “Avançar”
Então a tela “Finalizar a adição da previdência” deve ser exibida

#Tela “Finalizar a adição da previdência”

Esquema do Cenário: CT19 - O usuário clica em “Adicionar”
Dado que esteja na tela “Finalizar a adição da previdência”
Quando clicar em “Adicionar”
Então será exibida a mensagem “Adicionado com Sucesso” e as opções “Adicionar um novo ativo”, “Adicionar uma nova previdência” e o botão de fechar.


Exemplos:
|instituição    |ativo                                                          |data_valida    |data_invalida    |valor    |quantidade |adicao                          |
|BANCO INTER    |COPESUL - FUNDO DE INVESTIMENTO MULTIMERCADO                   |02/02/2020     |20/20/2020       |R$10,00  |1          |por preço da cota e quantidade  |
