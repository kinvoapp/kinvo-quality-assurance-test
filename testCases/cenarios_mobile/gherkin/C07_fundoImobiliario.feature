...
Funcionalidade: cadastrar fundo imobiliário
Como cliente Kinvo quero cadastrarum fundo imobiliário
...
E clicar em “Avançar”
Então a tela de “Escolha o papel” deve ser exibida
...
E clicar em “Avançar”
Então a tela “Escolha o papel” deve ser exibida

#Tela “Escolha o papel”

Esquema do Cenário: CT03 - O usuário não seleciona o papel
Dado que eu esteja na tela “Escolha o papel”
Quando não selecionar um papel
Então o botão “Avançar” deve permanecer inativo

Esquema do Cenário: CT04 - O usuário seleciona o papel e clica em “Avançar”
Dado que eu esteja na tela “Escolha o papel”
...
Então será exibida a mensagem “Adicionado com Sucesso” e as opções “Adicionar um novo ativo”, “Adicionar uma novo fundo imobiliário” e o botão de fechar.


xemplos:
|instituição    |papel  |data_valida    |data_invalida    |preco    |taxa       |quantidade |
|BANCO INTER    |ABCP11 |02/02/2020     |20/20/2020       |R$10,00  |R$0,10     |1          |
|NUBANK         |AFOF11 |30/12/2018     |36/10/2017       |R$40,00  |R$15,00    |99         |
